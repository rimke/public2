...
ET.extend({sha1:{
	initialize:function(){
		...
		ET.extend(this.fn, {
			...
			,'chrsz':this.chrsz /*   base-64   pad   character.   "="   for   strict   RFC   compliance       */
		});
	}
	,chrsz:8 /*   bits   per   input   character.   8   -   ASCII;   16   -   Unicode             */	
	,hex_sha1:function(s){
	    return this.fn.binb2hex(this.fn.core_sha1(this.fn.str2binb(s), s.length * this.chrsz));
	}
	,b64_sha1:function(s) {
	    return this.fn.binb2b64(this.fn.core_sha1(this.fn.str2binb(s), s.length * this.chrsz));
	}
	,str_sha1:function(s) {
	    return this.fn.binb2str(this.fn.core_sha1(this.fn.str2binb(s), s.length * this.chrsz));
	}
	,hex_hmac_sha1:function(key, data) {
	    return this.fn.binb2hex(this.fn.core_hmac_sha1(key, data));
	}
	,b64_hmac_sha1:function(key, data) {
	    return this.fn.binb2b64(this.fn.core_hmac_sha1(key, data));
	}
	,str_hmac_sha1:function(key, data) {
	    return this.fn.binb2str(this.fn.core_hmac_sha1(key, data));
	}
	/*   
